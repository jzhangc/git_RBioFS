#' @title rbioRF_initialFS_plot
#'
#' @description Variable importance (VI) plot function for \code{rf_ifs} obejcts generated by \code{rbioRF_initialFS()} or \code{rbioFS()}.
...
#' @examples
#' \dontrun{
#' rbioRF_initialFS_plot(object = data_initial_FS, n = "all",plot.title = TRUE, plot.titleSize = 10,
...
#' }
#' @export
rbioRF_initialFS_plot <- function(object, n = "all",
                                   ...
                                   plot.yLabel = "Mean Decrease in Accuracy", plot.yLabelSize = 10, plot.yTickLblSize = 10, plot.yTickItalic = FALSE,
                                   plot.yTickBold = FALSE,
                                   plot.Width = 170, plot.Height = 150){
  ## check arguments
  if (class(object) != "rf_ifs") stop("object needs to be \"rf_ifs\" class generated by rbioRF_initialFS() or rbioFS()")
  ...
  cat(paste("VI boxplot being saved to file: ", plot.file.title,".rffs.ifs.plot.pdf...", sep = ""))  # initial message
  loclEnv <- environment()
...
#' @param ... Additional arguments passed to the plot function \code{\link{rbioRF_initialFS_plot}}.
...
rbioRF_initialFS <- function(objTitle = "x_vs_tgt",
  ...
  ## plot
  if (plot){
    rbioRF_initial_FS_plot(object = outlst, n = n, plot.file.title = objTitle,...)
  }
