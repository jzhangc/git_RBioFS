...
#'
#' @description Variable OOB error rate curve plot function for \code{rf_sfs} obejcts generated by \code{rbioFS_rf_SFS()} or \code{rbioFS()}.
...
rbioFS_rf_SFS_plot <- function(object, n = "all",
                            ...
                            verbose = TRUE){
  ## check arguments
  if (class(object) != "rf_sfs") stop("object needs to be \"rf_sfs\" class generated by rbioFS_rf_SFS() or rbioFS()")
